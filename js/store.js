  ...
  // Scroll animation for footer
    ...
    document.addEventListener('DOMContentLoaded', function () {
      ...
      // Observe all animated elements
      const animatedElements = document.querySelectorAll('.section-title, .section-subtitle, .features-grid, .feature-detail, .comparison-container, .testimonials-container, .faq-container, .cta-title, .cta-description, .cta-button');
      animatedElements.forEach(el => {
        observer.observe(el);
      });
